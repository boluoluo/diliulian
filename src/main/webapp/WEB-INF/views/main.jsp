...
<div class="row  border-bottom white-bg dashboard-header animated fadeInRight">
			...
			<div class="ibox-content">
				<p>
					<i class="fa fa-qq"></i> QQ：<a
						...
						target="_blank">9715234</a>
				</p>
				<p>
					<i class="fa fa-weixin"></i> 微信：<a href="javascript:;">feiyuanxing</a>
				</p>
				<p>
					<i class="fa fa-credit-card"></i> 支付宝：<a href="javascript:;"
						class="支付宝信息"> 第六连 ：费元星</a>
				</p>
				<hr>
				<p>
					如果需要赞助第六连模板，可直接付款到支付宝：<a href="javascript:void(0);">13002171912</a>，
					收款人：<a href="javascript:void(0);">费元星</a>。
				</p>
	...
	<div class="col-sm-4">
		<div class="ibox float-e-margins">
			...
			<div class="ibox-content">
				<p>
					如果喜欢第六连模板，希望获取到源码，请前往我们的官网  <a href="http://www.feiyuanxing.com" target="_blank">www.feiyuanxing
					.com</a>获取源码
					请时常关注我们，因为我们将不定期更新功能修复BUG，您也可以提出您的宝贵 意见或者发现的BUG，
					作者将在第一时间处理并且通知到您	，第六连模板的成长离不开大家的 支持。
				</p>
				<ol>
					<li>访问 <a href="http://www.feiyuanxing.com" target="_blank">www.feiyuanxing.com</a></li>
					<li>点击发现</li>
					<li>获取源码 /在线演示</li>
									...
									<div class="panel-body">
										<ol>
											...
											<li>Spring大家族的SpringFOX在线文档,目前未提供生成静态的.卖命开发中...
												http://localhost:8080/diliulian/springfox/index.html</li>
										</ol>
									</div>
								</div>
							</div>
		...
		<div class="col-md-6">
			<div class="alert alert-danger">
				...
				<div style="font-size: 17px;">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 第六连
					有一个自己的网站空间,所有在学习和使用 第六连模板 系统的同志们可以加入到众筹的行列支持作者<b>（主要云服务器以及域名需要收费）</b>, 以下是
					第六连 系统捐助的支付页面，由于空间网站需求收费，故此征集大家为 第六连 系统做一点贡献，有了你的支持，第六连
