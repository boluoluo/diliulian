package com.diliulian.platform.service.${upPack}.impl;

import java.util.List;
import com.diliulian.platform.entity.DataGrid;
import com.github.pagehelper.PageInfo;
import org.springframework.stereotype.Service;
import com.diliulian.platform.entity.${proClass}Entity;
import com.diliulian.platform.entity.AjaxJson;
import com.diliulian.platform.service.${upPack}.${proClassLower}.${proClass}Service;
