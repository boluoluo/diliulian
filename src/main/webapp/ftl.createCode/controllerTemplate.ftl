package com.diliulian.platform.controller.${upPack};
...
import com.diliulian.platform.entity.${upPack}.${proClass}Entity;
import com.diliulian.platform.service.${upPack}.${proClass}Service;
