package com.diliulian.platform.entity.${upPack};

import com.diliulian.platform.entity.community.CommunityEntity;
import com.diliulian.platform.entity.hospital.HospitalEntity;
