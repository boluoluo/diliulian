...
public class LoginController
{
	...
	public String install() throws Exception
	{
		try
		{
			...
			runner.runScript((new InputStreamReader(getClass().getResourceAsStream("/doc/intall.sql"), "UTF-8")));
