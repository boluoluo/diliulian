package com.diliulian.platform.service.utils.impl;
...
import com.diliulian.framework.redis.RedisOperator;
import com.diliulian.platform.cache.SecondLevelCached;
...
import com.diliulian.platform.service.utils.CodeGeneratorService;
import com.diliulian.util.generator.FileUtil;
import com.diliulian.util.generator.Freemarker;
import com.diliulian.util.generator.PathUtil;
...
public class CodeGeneratorServiceImpl implements CodeGeneratorService
{
	...
	public void generateCode(HttpServletResponse response, String uuid) throws Exception
	{
		...
		for (CodeColumnEntity entity :entityList){
			entity.setAttributeName(com.diliulian.util.StringUtils.replaceUnderlineAndfirstToUpper(entity.getAttributeName(),"_",""));
