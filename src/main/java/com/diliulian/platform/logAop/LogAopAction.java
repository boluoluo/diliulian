package com.diliulian.platform.logAop;
...
public class LogAopAction
{
	 ...
	 * Controller 拦截点,前置通知
	 */
	@Pointcut("@annotation(com.diliulian.annotation.SystemLog)")
